...
import FeaturesOfOurServices6 from "./FeaturesOfOurServices6";
...
function PlanLinux() {
  ...
  return (
    <>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            ...
            <p className="mb-5 font-light text-white sm:text-xl">
              أفضل إستضافة لتطبيقات Laveral و PHP وتحتوي على نظام التثبيت بضغطة
              واحدة
            </p>
      ...
      <FeaturesOfOurServices6 />
      <Footer />
    </>
  );
}

export default PlanLinux;
