    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          const groupId = response.data.group._id; // الحصول على معرف المجموعة من الاستجابة
          ...
          Swal.fire({
            ...
            // إعادة التوجيه إلى صفحة إدارة تفاصيل المجموعة
            navigate(`/DetailsVPSGroup/${groupId}`);
          });
