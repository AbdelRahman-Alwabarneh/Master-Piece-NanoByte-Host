function ButtonDedicatedServer({ onClick }) {
    return (
      <>
  <button  onClick={onClick} className={`font-cairo mt-auto group/button relative inline-flex items-center justify-center overflow-hidden rounded-md bg-blue-500/30 backdrop-blur-lg px-4 py-2 text-sm font-semibold text-white transition-all duration-300 ease-in-out hover:scale-[1.03] hover:shadow-xl hover:shadow-blue-600/50  border border-white/20 whitespace-nowrap`}>
