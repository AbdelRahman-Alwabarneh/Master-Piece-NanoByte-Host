  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/InvoicePDF/generate-pdf/${
          invoice.orderNumber
        }`,
        {
          responseType: "blob",
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex justify-between group relative">
                ...
                {invoice.paymentStatus === "Pending" ? (
                  <span className="inline-flex items-center px-3 py-1 rounded-full bg-yellow-600/20 text-yellow-400 text-sm cursor-pointer">
              ...
              <button
                ...
                className={`w-full ${
                  isDownloading
                    ...
                    : "bg-nano-primary-300 hover:bg-nano-primary-400"
                } text-nano-text-100 font-bold py-3 px-4 rounded transition duration-300 text-sm shadow-md relative overflow-hidden`}
              ...
              >
                {!isDownloading ? (
                  ...
                  <div className="flex flex-col items-center w-full">
                    ...
                    <div className="text-xs text-nano-text-100 font-bold">
                      {progress}%
                    </div>
                    <div
