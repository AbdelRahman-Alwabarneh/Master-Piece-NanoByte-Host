...
import ButtonGameHosting from "./Button";
import { useNavigate } from "react-router-dom";

const GameHostingGroupsAndPlans = ({ motion, AnimatePresence }) => {
                      ...
                      <tbody>
                        {group.plans.map((plan, index) => (
                          ...
                          >
                            ...
                            <td className="px-8 py-6">{plan.ram}</td>
                            <td className="px-8 py-6">{plan.cpu}</td>
                            <td className="px-8 py-6">{plan.storage}</td>
                            <td className="px-8 py-6">
                              {plan.connectionSpeed}
                            </td>
                            <td className="px-8 py-6">{plan.security}</td>
                            <td className="px-8 py-6">
