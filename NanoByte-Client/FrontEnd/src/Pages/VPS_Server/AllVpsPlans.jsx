                        ...
                        >
                          ...
                          <th
                            ...
                            >
                              ...
                              {!plan.isUnlimited && (
  <div
    className={`absolute -top-5 ${plan.quantity < 10 ? '-right-10 -top-4' : plan.quantity < 100 ? '-right-12' : '-right-14'} transform -translate-x-1/2 rounded bg-gradient-to-r from-blue-900 to-blue-700 text-white text-xs px-2 py-1 shadow-lg font-bold rotate-45 origin-bottom-left max-w-full overflow-hidden`}
    style={{
      backgroundImage: 'linear-gradient(to right, #194f86, #1e3a8a)',
      boxShadow: '0 4px 6px rgba(0, 0, 0, 0.3)',
      borderBottom: '2px solid #142f60', // لون أزرق داكن جداً
    }}
  >
    متبقي {plan.quantity}
  </div>
                          ...
                          <td className="px-6 py-4">
                            <span 
                              onClick={() => (!plan.isUnlimited && plan.quantity === 0) ? null : goToDetails(plan.planName)}
                              className={(!plan.isUnlimited && plan.quantity === 0) ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}
                            >
                              <ButtonVps />
                            </span>
                          </td>
